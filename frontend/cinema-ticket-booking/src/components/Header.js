            ...
            <div className="flex px-5 w-full h-16 lg:h-20 bg-zinc-800/80 items-center rounded-md backdrop-blur-md">
                ...
                <div className="w-1/3 lg:w-fit lg:order-3">
                    <div class="w-fit ml-auto">
                        <Link to={`account`}>
                            <div class="flex items-center w-fit space-x-1.5 p-1 sm:py-1.5 sm:pl-2 sm:pr-3 rounded bg-zinc-700/50 transition duration-300 hover:bg-zinc-700/90 hover:shadow-xl">
                                <IconUserCircle size="30" className="" />
